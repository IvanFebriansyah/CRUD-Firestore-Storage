        ...
        firebaseFirestore.collection("Contacts").whereEqualTo("telepon", teleponId)
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(com.ivan.pertemuan12.ActivityDetailContact.this, "Error getting documents",
        ...
        if (filePath != null) {
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(com.ivan.pertemuan12.ActivityDetailContact.this, "Data berhasil disimpan",
                            Toast.LENGTH_SHORT).show();
                    finish();
                }
            });
            ...
            uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(com.ivan.pertemuan12.ActivityDetailContact.this, "Failed " + e.getMessage(),
